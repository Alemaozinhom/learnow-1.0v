        ...
        <section id="cover" class="top-cont" style="height: 92%;">
            <div id="cover-caption">        	
                <div class="container" id="cnt-menu">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/create<?php print(rand(1,5)); ?>.png" id="img-native">
                        </div>
                        <div class="col-sm-8 colun">
                            <label class="h1">Conta criada</label>
                            <br>Agora você pode explorar nosso recursos!
                            <br><a href="conectar">Conectar-se</a>
                        </div>
                    </div>
                    <br>
                </div>
