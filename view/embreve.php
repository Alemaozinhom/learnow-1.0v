        ...
        <section id="cover" class="top-cont" style="height: 92%;">
            <div id="cover-caption">        	
                <div class="container" id="cnt-menu">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/notfound<?php print(rand(1,2)); ?>.png" id="img-native">
                        </div>
                        <div class="col-sm-8 colun">
                            <label class="h1">Em breve!</label>
                            <br>Ainda não concluimos essa parte :C
                        </div>
                    </div>
                    <br>
                </div>
