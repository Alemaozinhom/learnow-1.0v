...
<html lang="pt_br">
    <head>
        ...
        <title>LearNow - Esqueci a Senha</title>
        ...
        <section id="cover" class="top-cont" style="height: 92%;">
            <div id="cover-caption">        	
                <div class="container" id="cnt-menu">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/password.png" id="img-native">
                        </div>
                        <div class="col-sm-8 colun">
                            <label class="h1">Recuperar senha</label>
                            <br>Fique calmo coloque as informações que vamos cuidar de tudo!
                        </div>
                    </div>
                    <div class="row">
                            <div class="col align-self-start"></div>
                            <div class="col-md-6 align-self-center">     
                                <form action="controller/ResetController.php" method="POST">
                                    <input type='text' name='auth' value='true' style='display:none;'>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail">Email</label>
                                            <input type="email" class="form-control" name="email" id="inputEmail" placeholder="Email do Usuário" value="" required>
                                        </div>          
                                    </div>           
                                    <div class="btn-align">
