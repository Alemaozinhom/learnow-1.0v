...
<html lang="pt_br">
    <head>
        ...
        <title>LearNow - Conta excluída</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-md-auto">
                    ...
                    <li class="nav-item" id="btnNav">
                        <a class="btn" style="color:white;" href="sobre">Contato</a>
                    </li> 
                    <li class='nav-item' id='btnNav'>
        ...
        <section id="cover" class="top-cont" style="height: 95%;">
            <div id="cover-caption">        	
                <div class="container" id="cnt-menu">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/remove<?php print(rand(1,5)); ?>.png" id="img-native">
                        </div>
                        <div class="col-sm-8 colun">
                            <label class="h1">Conta excluída</label>
                            <br>Esta conta não pode ser mais acessada
                            <br><a href="/learnow">Ir para home</a>
                        </div>
                    </div>
                    <br>
                </div>
