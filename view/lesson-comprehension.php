<?php
    require_once "controller/ComprehensionController.php";
    ...
    $ComprehensionController->loadGrammar($_POST['ID']);

    if ($ComprehensionController->getTitle()!='Verbo to be') 
    {
...
<html lang="pt_br">
    <head>
        ...
        <title>LearNow - Comprehension Lesson</title>
        ...
        <section id="cover" style="height: auto;">
            <div id="cover-caption">
                <div class="container" id="cnt-lesson">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/howfcomp.png" id="img-lesson">
                        </div>
                            <?php $ComprehensionController->getComprehension(); ?>
                    </div>
                </div>
                ...
                ?>                
                    <?php $ComprehensionController->getQuestions(); ?>
