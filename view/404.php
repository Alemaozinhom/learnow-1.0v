        ...
        <section id="cover" class="top-cont">
            <div id="cover-caption">        	
                <div class="container" id="cnt-menu">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="view/img/error<?php print(rand(1,3)); ?>.png" id="img-native">
                        </div>
                        <div class="col-sm-8 colun">
                            <label class="h1">Página não existe!</label>
                            <br>A url inserida não foi encontrada :(
                        </div>
                    </div>
                    <br>
                </div>
